    ...
    <?php 
        ...
        if(isset($_GET['pesan'])){
            if($_GET['pesan'] == "berhasil"){
			 ...
			 if($_GET['pesan'] == "gagal"){
                 echo "<script type='text/javascript'>alert('RFID Sudah Pernah Didaftarkan');</script>";
             }
         }
	?>
                        ...
                        <ul class="navbar-nav flex-column">
                            <li class="nav-divider">
								...
								<ul class="nav flex-column">
									...
									<li class="nav-item">
                                        <a class="nav-link" href="tambah-saldo.php">Top Up</a>
                                    </li>
									<li class="nav-item">
                                        <a class="nav-link" href="log-topup.php">Log Top Up</a>
                                    </li>
									<li class="nav-item">
                                        <a class="nav-link" href="tambah-tol.php">Tambah Tol</a>
                                    </li>
									<li class="nav-item">
                                        <a class="nav-link" href="log-tol.php">Data Tol</a>
                                    </li>
                                </ul>
                            </li>   
                            <li class="nav-divider">
                                ...
                                <form action="action-input-data.php" method="POST" name="form-input-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                            if($rfid == 1) {
                                                ?>
                                                <input type="text" class="form-control" name="rfid" id="rfid" placeholder="Masukan rfid" required value="<?= $data['rfid'] ?>">
                                                <?php
                                            }
                                            else{
                                                ?>
                                                <input type="text" class="form-control" name="rfid" id="rfid" placeholder="Masukan rfid" required>
                                            <?php
                                            }
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" cols="30" rows="5" class="form-control" placeholder="Masukan alamat"required></textarea>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="saldo" placeholder="Masukan saldo"required>
                                    </div>
